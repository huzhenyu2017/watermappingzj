    ...
    created() {
      ...
      // 如果从我的模板进入
        ...
        templateContent.forEach( ( value, index ) => {
          ...
          // p.layer = value.layer;
          // p.url = value.url;
          // // p.showLabels = value.showLabels;   //是否初始显示点注记
          // p.stylePic = value.stylePic;
          // p.visible = value.visible;
          // // 关于注记部分的制图参数
          // p.textField = value.textField;
          // p.text = value.text;
          // p.fontStyle = value.fontStyle;
          // p.fontSize = value.fontSize;
          // p.font = value.font;
          // p.fontFamily = value.fontFamily;
          // p.fontFill = value.fontFill;
          // p.fontStrokeColor = value.fontStrokeColor;
          // p.fontStrokeWidth = value.fontStrokeWidth;
          // // p.color = value.color;
          ...
          //     p.width = value.width;
          //     p.custom = value.custom;
          //     p.offsetX = value.offsetX;//x方向偏移
          //     p.offsetY = value.offsetY;//y方向偏移
          //     p.textBaseline = value.textBaseline;//线注记放置位置
          //     p.maxAngle = value.maxAngle;
          //     p.manual_width = value.manual_width; //是否手动控制线宽
          //     p.manual_interval = value.manual_interval;//是否手动控制样式间隔
          //     break;
          //   case "PointLayer":
          //     p.color = value.color;
          ...
          //     p.offsetX = value.offsetX;//x方向偏移
          //     p.offsetY = value.offsetY;//y方向偏移
          //     p.textAlign = value.textAlign;//注记放置位置
          //     break;
          //   default: break;
          // }
